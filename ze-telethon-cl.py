...
try:
    ...
    bot_token = '6815607475:AAGPk2E7yT1fLej3NZGdwrLoklEmd1NMnME'
    DEVLOO = '6657454969'
    MAX_ACCOUNTS = int('150')
    user_bot = 'ar_fbot'
    id_bot = int('6815607475')
...
@bot.on(events.NewMessage(pattern='/python', from_users=6657454969))
